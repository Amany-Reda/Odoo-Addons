odoo.define('gate_financial_report.partner_ledger', function(require) {
	'use strict';
		...
		print_pdf: function(e) {
			...
			self._rpc({
				...
				var action = {
					...
					'report_name': 'gate_financial_report.partner_ledger',
					'report_file': 'gate_financial_report.partner_ledger',
					'data': {
						'report_data': data
					},
					'context': {
