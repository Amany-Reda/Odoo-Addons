odoo.define('gate_financial_report.trial_balance', function(require) {
	'use strict';
		...
		print_pdf: function(e) {
			...
			self._rpc({
				...
				var action = {
					...
					'report_name': 'gate_financial_report.trial_balance',
					'report_file': 'gate_financial_report.trial_balance',
					'data': {
						'report_data': data
					},
					'context': {
