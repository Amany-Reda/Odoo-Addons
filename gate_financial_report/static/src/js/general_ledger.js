odoo.define('gate_financial_report.general_ledger', function(require) {
	'use strict';
	...
	var QWeb = core.qweb;
	var _t = core._t;
	var trial = require('gate_financial_report.trial_balance');
		...
		print_pdf: function(e) {
			...
			self._rpc({
				...
				var action = {
					...
					'report_name': 'gate_financial_report.general_ledger',
					'report_file': 'gate_financial_report.general_ledger',
					'data': {
						'report_data': data
					},
					'context': {
