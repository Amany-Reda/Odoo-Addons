odoo.define('gate_financial_report.ageing', function(require) {
	'use strict';
		...
		print_pdf: function(e) {
			...
			self._rpc({
				...
				var action = {
					...
					'report_name': 'gate_financial_report.partner_ageing',
					'report_file': 'gate_financial_report.partner_ageing',
					'data': {
						'report_data': data
					},
					'context': {
