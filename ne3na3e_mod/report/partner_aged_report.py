...
class ReportAgedPartnerBalance(models.AbstractModel):
    _name = 'report.ne3na3e_mod.partner_aged'
    ...
    def _get_partner_move_lines(self, account_type, partner_ids,
        ...
        for partner in partners:
            ...
            if partner['partner_id']:
                ...
                values['phone'] = browsed_partner.phone  # Add phone number
                values['sales_person'] = browsed_partner.sales_person  # Add sales person


            else:
                values['name'] = _('Unknown Partner')
                values['trust'] = False
                values['phone'] = ''  # Add empty phone number for unknown partner
                values['sales_person'] = ''  # Add empty sales person for unknown partner
    ...
    def _get_report_values(self, docids, data=None):
        ...
        for partner in movelines:
            partner['phone'] = self.env['res.partner'].browse(partner['partner_id']).phone
            partner['sales_person'] = self.env['res.partner'].browse(partner['partner_id']).sales_person.name
