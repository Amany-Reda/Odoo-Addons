...
class PosConfig(models.TransientModel):
    ...
    external_email_server_default = fields.Boolean(
        string='External Email Server Default',
        config_parameter='res.config.settings.external_email_server_default')
    ...
    def get_values(self):
        ...
        res.update(
            invoice_auto_check=get_param(
                'pos_invoice_automate.invoice_auto_check'),
            button_operation=get_param('pos_invoice_automate.button_operation'),
    ...
    def set_values(self):
        ...
        set_param('pos_invoice_automate.invoice_auto_check',
                  self.invoice_auto_check)
        set_param('pos_invoice_automate.button_operation',
                  self.button_operation)
        set_param('res.config.settings.external_email_server_default',
